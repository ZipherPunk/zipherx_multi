...
impl Parameters for MainNetwork {
    fn activation_height(&self, nu: NetworkUpgrade) -> Option<BlockHeight> {
        match nu {
            ...
            // ZclassicButtercup is not activated on Zcash mainnet
            NetworkUpgrade::ZclassicButtercup => None,
        }
    }
...
impl Parameters for TestNetwork {
    fn activation_height(&self, nu: NetworkUpgrade) -> Option<BlockHeight> {
        match nu {
            ...
            #[cfg(feature = "zfuture")]
            NetworkUpgrade::ZFuture => None,
            // ZclassicButtercup is not activated on Zcash testnet
            NetworkUpgrade::ZclassicButtercup => None,
        }
    }
...
pub enum NetworkUpgrade {
    ...
    /// Activated at height 707,000 on Zclassic mainnet.
    ZclassicButtercup,
}
...
impl fmt::Display for NetworkUpgrade {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            NetworkUpgrade::ZclassicButtercup => write!(f, "ZclassicButtercup"),
        }
    }
}
...
///
/// NOTE: ZclassicButtercup is included for Zclassic network support.
/// On Zclassic, Blossom/Heartwood/Canopy/Nu5 are not activated (return None from
/// activation_height), so only ZclassicButtercup will match after Sapling.
const UPGRADES_IN_ORDER: &[NetworkUpgrade] = &[
    ...
    NetworkUpgrade::Nu5,
    // Zclassic-specific upgrade (activated at height 707,000 on ZCL mainnet)
    NetworkUpgrade::ZclassicButtercup,
];
...
impl TryFrom<u32> for BranchId {
    ...
    fn try_from(value: u32) -> Result<Self, Self::Error> {
        match value {
            ...
            // Zclassic Buttercup (post-Sapling fork)
...
impl BranchId {
    ...
    pub fn height_bounds<P: Parameters>(
        ...
        match self {
            ...
            // Zclassic Buttercup - no upper bound (currently active)
            BranchId::ZclassicButtercup => params
